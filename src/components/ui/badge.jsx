  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        accepted: "border-transparent bg-blue-100 text-blue-800 hover:bg-blue-200",
        in_progress: "border-transparent bg-purple-100 text-purple-800 hover:bg-purple-200",
        ...
        low: "border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200",
